...
smolnes: deobfuscated.c apu.c bbk/bbk.c bbk/nes_fdc.c bbk/nes_joy.c
	$(CC) -O2 -o $@ $^$> ${SDLFLAGS} -g ${WARN}

smolnes.wasm: deobfuscated.c apu.c bbk/bbk.c bbk/nes_fdc.c bbk/nes_joy.c wasm/libc/libc.c
