...
smolnes.wasm: deobfuscated.c apu.c bbk/bbk.c bbk/nes_fdc.c bbk/nes_joy.c bbk/LPC_D6_SYNTH.c wasm/libc/libc.c
	clang --target=wasm32 -O3 -nostdlib -fno-builtin -ffunction-sections -fdata-sections -I wasm/libc ${CFLAGS} -Wl,--gc-sections -Wl,--export-dynamic -Wl,--no-entry -Wl,--strip-all -Wl,--allow-undefined -o $@ $^$> ${WARN}
